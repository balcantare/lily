...
lyrStropheA = {
  ...
  Weiß, weiß, weiß, liegt die gan -- ze Welt.
  Auch der Mond auf sei -- ner Bahn ist ganz
  still, schaut  sich die Welt von o -- ben an.
  Al -- le Vög -- lein schla -- fen nun,
  und für uns Men -- schen kommt die Zeit
  aus -- zu -- ruhn.
}}
...
lyrStropheAbass = {
  ...
  Weiß,2 weiß, weiß,1 liegt4 die gan -- ze Welt.1
  Auch2 der Mond4 auf sei -- ner Bahn1.
  \skip 2 \repeat unfold 3 {\skip 1} \skip 2.
  Al2. -- le2 Vög4 -- lein schla -- fen nun,1
...
lyrStropheB = {
  ...
  leuch -- tet hell ein Stern, den
  rings -- um nie -- mand kennt.
  Hast in die -- ser ei -- nen Nacht
  den Men -- schen Frie -- den in ihr
  Herz ge _ -- bracht.
}}
...
lyrStropheBbass = {
  ...
  %rings -- um nie -- mand kennt.
  \skip 2 \repeat unfold 3 {\skip 1} \skip 2.
  Hast2. in2 die4 -- ser ei -- nen Nacht1
  \repeat unfold 3 {\skip 1}
  mh2 mh mh
}}
